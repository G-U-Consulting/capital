...
select
	...
	@asoleacion,
	@altura,
	if(@cerca_porteria = '1', 1, 0),
	if(@cerca_juegos_infantiles = '1', 1, 0),
	if(@cerca_piscina = '1', 1, 0),
	if(@tiene_balcon = '1', 1, 0),
	if(@tiene_parq_sencillo = '1', 1, 0),
	if(@tiene_parq_doble = '1', 1, 0),
	if(@tiene_deposito = '1', 1, 0),
	if(@tiene_acabados = '1', 1, 0);
