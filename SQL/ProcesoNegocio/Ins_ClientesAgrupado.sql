...
select
    ...
    JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.pais_tel1')),
    JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.codigo_tel1')),
    JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.telefono2')),
    JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.pais_tel2')),
    JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.codigo_tel2')),
    ...
    NULLIF(NULLIF(JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.fechaExpedicion')), ''), '0000-00-00'),
    ...
    NULLIF(NULLIF(JSON_UNQUOTE(JSON_EXTRACT(j.value, '$.fechaNacimiento')), ''), '0000-00-00'),
