...
--END_PARAM
INSERT INTO dim_sala_venta (sala_venta, encuesta_vpn, id_sede, id_playlist, id_zona_proyecto, id_ciudadela, is_feria, pro_futuros, id_cordinador, email_cordinacion) 
VALUES (@sala_venta, @encuesta_vpn, if(@id_sede = '', NULL, @id_sede), @id_playlist, 
    ...
    if(@id_cordinador = '', NULL, @id_cordinador), email_cordinacion);
