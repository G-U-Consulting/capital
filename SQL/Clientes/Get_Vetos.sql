...
select id_veto, date_format(vc.fecha, '%d/%m/%Y %T') as fecha, vc.motivo, 
    ...
    c.numero_documento, u.nombres as vetado_por
from dim_veto_cliente vc 
join fact_clientes c on vc.id_cliente = c.id_cliente
join fact_usuarios u on vc.vetado_por = u.usuario collate utf8mb4_general_ci;