...
select id_veto, date_format(vc.fecha, '%Y-%m-%d') as fecha, vc.motivo, vc.vigente,
    c.nombres, c.apellido1, c.apellido2, c.email1, c.email2, c.telefono1, c.telefono2,
    ...
    c.numero_documento, us.nombres as solicitado_por, uv.id_usuario as asignado, uv.nombres as vetado_por
