...
select id_obj, id_cliente, nombre_cliente, id_unidad, unidad, id_proyecto, proyecto,
    date_format(created_on, '%Y-%m-%d %H:%i') as created_on, asesor, nombre_asesor, obj, id_sede, id_zona_proyecto, id_ciudadela
from (
    select id_visita as id_obj, v.id_cliente, 
        ...
        v.created_on, v.created_by as asesor, us.nombres as nombre_asesor, 'Visita' as obj,
    ...
    co.created_on, co.created_by as asesor, us.nombres as nombre_asesor, 'Cotización' as obj,
        p.id_sede, p.id_zona_proyecto, p.id_ciudadela
    ...
    select o.id_opcion as id_obj, co.id_cliente, 
        concat(coalesce(c.nombres, ''), ' ', coalesce(c.apellido1, ''), ' ', coalesce(c.apellido2, '')) as nombre_cliente,
        n.id_unidad, group_concat(coalesce(a.nombre, un.nombre_unidad) separator '/') as unidad, p.id_proyecto, p.nombre as proyecto,
        o.created_on, o.created_by as asesor, us.nombres as nombre_asesor, 'Opción' as obj,
        p.id_sede, p.id_zona_proyecto, p.id_ciudadela
    from fact_opcion o
    ...
    select id_venta as id_obj, co.id_cliente, 
        ...
        v.created_on, v.created_by as asesor, us.nombres as nombre_asesor, 'Venta' as obj,
        p.id_sede, p.id_zona_proyecto, p.id_ciudadela 
    from fact_ventas v 
    ...
    select d.id_desistimiento as id_obj, co.id_cliente, 
        concat(coalesce(c.nombres, ''), ' ', coalesce(c.apellido1, ''), ' ', coalesce(c.apellido2, '')) as nombre_cliente, 
        un.id_unidad, coalesce(a.nombre, un.nombre_unidad) as unidad, p.id_proyecto, p.nombre as proyecto,
        d.created_on, d.created_by as asesor, us.nombres as nombre_asesor, 'Desistimiento' as obj,
        p.id_sede, p.id_zona_proyecto, p.id_ciudadela
