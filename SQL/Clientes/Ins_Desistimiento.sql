...
insert into dim_desistimiento(
    ...
    pnl_monto, v_venta_neto, a_capital, a_intereses, condonacion, imp_reformas, pnl_pcv, pnl_aplicada_ptg, created_by, updated_by
) values (
    ...
    @Monto, @v_venta_neto, @a_capital, @a_intereses, @condonacion, @imp_reformas, @pnl_pcv, @pnl_aplicada_ptg, @created_by, @created_by
);
